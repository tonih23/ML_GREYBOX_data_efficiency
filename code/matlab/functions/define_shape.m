...
switch what
    ...
    case "cylinder"
        ...
        param.joint_pos = [0.2003   -0.0352   -0.0122;  0.0746   -0.0044    0.0007];
        ...
        [X, Y, Z] = cylinder(param.radius*0.8, param.num_theta);
        for i = 1:param.num_theta+1
            X_up(:,i) = linspace(X(1, i), X(end, i), param.num_length)';
            Y_up(:,i) = linspace(Y(1, i), Y(end, i), param.num_length)';
            Z_up(:,i) = linspace(Z(1, i), Z(end, i)*param.x_lim, param.num_length)'-0.02;
        end
